---
title: "Зависимости: Архитектурный разбор"
description: "4 типа: 3 баги (лечить), 1 фича (исполнять). Химия, коррупция, аддикция, любовь."
date: 2026-03-16
tags: [зависимость, аддикция, коррупция, любовь, архитектура, лечение]
lang: ru
---

> **Архивное философское эссе.** Это метафора, а не медицинская модель и не рекомендация по лечению. Текущий проверяемый пример: [Whaler](whaler.md).
