---
title: "Архитектурный манифест: почему мы открыты (и почему нет)"
description: "Гибридная модель: открытый эмулятор, контролируемый IDE и Store."
date: 2026-03-15
tags: [открытость, контроль, гибрид]
lang: ru
---
...
- [Суверенитет для авторов](suveren.md)
